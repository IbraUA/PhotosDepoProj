...
Маршрути API
 ...
 /upload - POST - Приймає файл (multipart/form-data, поле file). Формати: .jpg, .png, .gif. Максимальний розмір: 5MB. Повертає пряме посилання на завантажене зображення або 400 Bad Request з описом помилки 
